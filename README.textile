...
# Download the "dictionary":https://github.com/downloads/neskie/secengmac/Secwepemc-English-latest.tar.bz2.
# Unzip the file and place Secwepemc-English.Dictionary in to ~/Library/Dictionaries/
